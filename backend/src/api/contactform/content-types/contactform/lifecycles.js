module.exports = {
    ...
    <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
        <tbody>
        <tr>
            <td class="title" width="300">Ramraj Associates</td>
            <td class="subject" width="300"><a class="strong" href="https://www.ramrajassociates.com" target="_blank">www.ramrajassociates.com</a></td>
        </tr>
        <tr>
